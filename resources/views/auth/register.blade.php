...
<section id="user_register">
    <div class="container">
        <div class="row justify-content-center register_box">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><h3>Registrati</h3></div>
    ...
    <div class="register-img-r">
        <img src="./img/register-r.svg" alt="">
    </div>
    <div class="register-img-l">
        <img src="./img/register-l.svg" alt="">
    </div>
</section>
@endsection
